...
public class DetectUnknownControllerMappings : MonoBehaviour {
	...
	void Update () {
        ...
        else if (SimpleInput.GetAxis("Axis 1") < 0f)
            axis1Value.text = "negative";
        else
            axis1Value.text = "";

        if (SimpleInput.GetAxis("Axis 2") > 0f)
            axis2Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 2") < 0f)
            axis2Value.text = "negative";
        else
            axis2Value.text = "";

        if (SimpleInput.GetAxis("Axis 3") > 0f)
            axis3Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 3") < 0f)
            axis3Value.text = "negative";
        else
            axis3Value.text = "";

        if (SimpleInput.GetAxis("Axis 4") > 0f)
            axis4Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 4") < 0f)
            axis4Value.text = "negative";
        else
            axis4Value.text = "";

        if (SimpleInput.GetAxis("Axis 5") > 0f)
            axis5Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 5") < 0f)
            axis5Value.text = "negative";
        else
            axis5Value.text = "";

        if (SimpleInput.GetAxis("Axis 6") > 0f)
            axis6Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 6") < 0f)
            axis6Value.text = "negative";
        else
            axis6Value.text = "";

        if (SimpleInput.GetAxis("Axis 7") > 0f)
            axis7Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 7") < 0f)
            axis7Value.text = "negative";
        else
            axis7Value.text = "";

        if (SimpleInput.GetAxis("Axis 8") > 0f)
            axis8Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 8") < 0f)
            axis8Value.text = "negative";
        else
            axis8Value.text = "";

        if (SimpleInput.GetAxis("Axis 9") > 0f)
            axis9Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 9") < 0f)
            axis9Value.text = "negative";
        else
            axis9Value.text = "";

        if (SimpleInput.GetAxis("Axis 10") > 0f)
            axis10Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 10") < 0f)
            axis10Value.text = "negative";
        else
            axis10Value.text = "";

        if (SimpleInput.GetAxis("Axis 11") > 0f)
            axis11Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 11") < 0f)
            axis11Value.text = "negative";
        else
            axis11Value.text = "";

        if (SimpleInput.GetAxis("Axis 12") > 0f)
            axis12Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 12") < 0f)
            axis12Value.text = "negative";
        else
            axis12Value.text = "";

        if (SimpleInput.GetAxis("Axis 13") > 0f)
            axis13Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 13") < 0f)
            axis13Value.text = "negative";
        else
            axis13Value.text = "";

        if (SimpleInput.GetAxis("Axis 14") > 0f)
            axis14Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 14") < 0f)
            axis14Value.text = "negative";
        else
            axis14Value.text = "";

        if (SimpleInput.GetAxis("Axis 15") > 0f)
            axis15Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 15") < 0f)
            axis15Value.text = "negative";
        else
            axis15Value.text = "";

        if (SimpleInput.GetAxis("Axis 16") > 0f)
            axis16Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 16") < 0f)
            axis16Value.text = "negative";
        else
            axis16Value.text = "";

        if (SimpleInput.GetAxis("Axis 17") > 0f)
            axis17Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 17") < 0f)
            axis17Value.text = "negative";
        else
            axis17Value.text = "";

        if (SimpleInput.GetAxis("Axis 18") > 0f)
            axis18Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 18") < 0f)
            axis18Value.text = "negative";
        else
            axis18Value.text = "";

        if (SimpleInput.GetAxis("Axis 19") > 0f)
            axis19Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 19") < 0f)
            axis19Value.text = "negative";
        else
            axis19Value.text = "";

        if (SimpleInput.GetAxis("Axis 20") > 0f)
            axis20Value.text = "positive";
        else if (SimpleInput.GetAxis("Axis 20") < 0f)
            axis20Value.text = "negative";
        else
            axis20Value.text = "";

		if (SimpleInput.GetAxis("Axis 21") > 0f)
			axis21Value.text = "positive";
		else if (SimpleInput.GetAxis("Axis 21") < 0f)
			axis21Value.text = "negative";
		else
			axis21Value.text = "";
		
		if (SimpleInput.GetAxis("Axis 22") > 0f)
			axis22Value.text = "positive";
		else if (SimpleInput.GetAxis("Axis 22") < 0f)
			axis22Value.text = "negative";
		else
			axis22Value.text = "";
		
		if (SimpleInput.GetAxis("Axis 23") > 0f)
			axis23Value.text = "positive";
		else if (SimpleInput.GetAxis("Axis 23") < 0f)
			axis23Value.text = "negative";
		else
			axis23Value.text = "";
		
		if (SimpleInput.GetAxis("Axis 24") > 0f)
			axis24Value.text = "positive";
		else if (SimpleInput.GetAxis("Axis 24") < 0f)
			axis24Value.text = "negative";
		else
			axis24Value.text = "";
		
		if (SimpleInput.GetAxis("Axis 25") > 0f)
			axis25Value.text = "positive";
		else if (SimpleInput.GetAxis("Axis 25") < 0f)
			axis25Value.text = "negative";
		else
			axis25Value.text = "";
		
		if (SimpleInput.GetAxis("Axis 26") > 0f)
			axis26Value.text = "positive";
		else if (SimpleInput.GetAxis("Axis 26") < 0f)
			axis26Value.text = "negative";
		else
			axis26Value.text = "";
		
		if (SimpleInput.GetAxis("Axis 27") > 0f)
			axis27Value.text = "positive";
		else if (SimpleInput.GetAxis("Axis 27") < 0f)
			axis27Value.text = "negative";
		else
			axis27Value.text = "";
		
		if (SimpleInput.GetAxis("Axis 28") > 0f)
			axis28Value.text = "positive";
		else if (SimpleInput.GetAxis("Axis 28") < 0f)
